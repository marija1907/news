...
<a href="ekonomija_admin.php" class="nav">Ekonomija</a><br><hr>



<?php
echo "welcome to IT VESTI<br>";
include "dbconnect.php";
$sql = "select title,description,text_news,category_news from news where category_news=3";
